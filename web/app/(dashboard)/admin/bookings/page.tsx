...
export default function AdminBookingsPage() {
  ...
  }, [page, search, statusFilter, tab, hostFilter, startDate, endDate]);
  ...
  const handleAction = async (type: string, bookingId: string, body: any = {}) => {
    ...
    try {
      ...
      setModal(null);
      setActionNote('');
      setDetail(null); // Close detail modal to refresh
      fetchBookings();
      fetchStats();
            ...
            <div className="flex gap-2.5 justify-end mt-6">
              ...
              <button
                ...
                className={cn(
                  ...
                  modal.type === 'refund-reject'
                    ? 'bg-rose-600 hover:bg-rose-700 shadow-rose-600/10'
                    : 'bg-indigo-600 hover:bg-indigo-700 shadow-indigo-600/10'
                )}
              >
                {acting ? 'Đang xử lý...' : modal.type === 'refund-approve' ? 'Phê duyệt' : 'Từ chối'}
              </button>
            </div>
          </div>
        </div>
