  ...
  return (
    <div className="loader-container-wrapper">
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .loader-container-wrapper .truckWrapper {
          width: 200px;
          height: 100px;
          display: flex;
        ...
        .loader-container-wrapper .truckBody {
          width: 130px;
          height: fit-content;
          margin-bottom: 6px;
        ...
        .loader-container-wrapper .truckTires {
          width: 130px;
          height: fit-content;
          display: flex;
          align-items: center;
        ...
        .loader-container-wrapper .truckTires svg {
          width: 24px;
        }
        .loader-container-wrapper .road {
          width: 100%;
          height: 1.5px;
        ...
        .loader-container-wrapper .road::before {
          content: "";
          position: absolute;
          width: 20px;
          height: 100%;
        ...
        .loader-container-wrapper .road::after {
          content: "";
          position: absolute;
          width: 10px;
          height: 100%;
        ...
        .loader-container-wrapper .lampPost {
          position: absolute;
          bottom: 0;
          right: -90%;
          height: 90px;
